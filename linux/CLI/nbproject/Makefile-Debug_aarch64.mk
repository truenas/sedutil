...
${OBJECTDIR}/_ext/7a2a93ab/DtaDevRuby1.o: ../../Common/DtaDevRuby1.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/7a2a93ab
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I.. -I../../Common -I../../Common/pbkdf2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7a2a93ab/DtaDevRuby1.o ../../Common/DtaDevRuby1.cpp
